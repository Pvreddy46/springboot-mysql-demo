...
import com.spring.db.demo.notifications.ContentIdGenerator;
...
//    sendMessageToAddress(simpleMessage, "pvreddy.java@gmail.com");
//   // Message messageWithAttachment = buildMessageWithAttachment(session);
//   // sendMessageToAddress(messageWithAttachment, "pvreddy.java@gmail.com");
//    Message withImage = buildMessageWithEmbeddedImage(session);
//    addressAndSendMessage(withImage, "pvreddy.java@gmail.com");
//  }
  ...
  public static Session buildSimpleSession() {
    ...
    mailProps.put("mail.from", "pvreddy.java@gmail.com");
  ...
  public static Session buildGoogleSession() {
    ...
    final PasswordAuthentication usernamePassword = new PasswordAuthentication(
        "pvreddy.java@gmail.com", "Venk@tReddy");
  ...
  public static Message buildMessageWithEmbeddedImage(Session session)
    ...
    textPart.setText("<html><head>"
      ...
      + "</head>\n"
      + "<body><div><b>Hi Pvreddy!</b></div>"
      + "<div>Welcome to HKSS!</i> </div>\n"
      + "<div><img src=\"cid:"
      + cid
      + "\" /></div>\n" + "<div>Please scan the above QR in Google Authenticator</div></body></html>", 
      "US-ASCII", "html");
    ...
    URL url = new URL("https://chart.googleapis.com/chart?chs=200x200&chld=M%%7C0&cht=qr&chl=otpauth%3A%2F%2Ftotp%2FSpringRegistration%3Apvreddy.java%40gmail.com%3Fsecret%3DY3XWKJFWRUK6YK5Q%26issuer%3DSpringRegistration");
//	Image image = ImageIO.read(url);
	
	File sourceimage = new File("https://chart.googleapis.com/chart?chs=200x200&chld=M%%7C0&cht=qr&chl=otpauth%3A%2F%2Ftotp%2FSpringRegistration%3Apvreddy.java%40gmail.com%3Fsecret%3DY3XWKJFWRUK6YK5Q%26issuer%3DSpringRegistration");
...
public static Message buildMessageWithEmbeddedImage(Session buildSimpleSession, String qR) throws MessagingException, IOException {
	// TODO Auto-generated method stub
	

    SMTPMessage m = new SMTPMessage(buildSimpleSession);
    MimeMultipart content = new MimeMultipart("related");
